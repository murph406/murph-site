...
var mongoose = require('mongoose'); // const serverless = require('serverless-http');
...
router.route('/auth/login').get(account.login); // router.route('/logout').get(account.logout);
